...
class ItemTouchHelperCallback(
    ...
    /**
     * Returns the movement flags for the given [recyclerView] and [viewHolder]. In this case, it allows
     * both dragging and swiping in all directions.
     */
    override fun getMovementFlags(
        ...
        return ItemTouchHelper.Callback.makeMovementFlags(
            ItemTouchHelper.ACTION_STATE_DRAG, // Allows dragging
            ItemTouchHelper.ACTION_STATE_SWIPE // Allows swiping
        )
    }
