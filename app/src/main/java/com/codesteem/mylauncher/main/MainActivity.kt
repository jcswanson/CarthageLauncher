...
import com.codesteem.mylauncher.adapter.AppSearchListener
...
class MainActivity : AppCompatActivity(), NotificationsAdapter.OnItemDeleteListener {
            ...
            when(result) {
                is Resource.Success -> {
                    result.data?.let { perplexityResponse ->
                        ...
                        content?.let {
                            if (it.index == 0) {
                                if (it.finish_reason == "stop" && !MySharedPreferences.getCopeTextHelpStatus(this@MainActivity)) {
                                    searchCopyBallon()
                                }
    ...
    private fun searchCopyBallon() {
        ...
        balloon.setOnBalloonDismissListener {
            MySharedPreferences.saveCopeTextHelpStatus(this@MainActivity, true)
    ...
    private fun initData() {
        ...
        dialogAdapter.setAppSearchListener(object : AppSearchListener{
            override fun onAppSelected() {
                binding.searchContainer.visibility=View.GONE
                binding.shortcutBar.visibility = View.VISIBLE
            }
        })
    ...
    private fun clickListeners() {
        ...
        binding.searchAction.setOnClickListener {
            ...
            binding.shortcutBar.visibility = View.GONE
