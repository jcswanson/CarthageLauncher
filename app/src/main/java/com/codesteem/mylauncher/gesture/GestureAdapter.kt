...
import com.codesteem.mylauncher.gesture.transactions.AddTransaction
import com.codesteem.mylauncher.gesture.transactions.InsertTransaction
import com.codesteem.mylauncher.gesture.transactions.MoveTransaction
import com.codesteem.mylauncher.gesture.transactions.RemoveTransaction
import com.codesteem.mylauncher.gesture.transactions.RevertReorderTransaction
import com.codesteem.mylauncher.gesture.transactions.SwapTransaction
import com.codesteem.mylauncher.gesture.transactions.Transaction
import com.codesteem.mylauncher.gesture.transactions.Transactional
import com.codesteem.mylauncher.gesture.util.FixedSizeArrayDequeue
import com.codesteem.mylauncher.gesture.util.getDataOffset
import java.util.*
...
abstract class GestureAdapter<T, K : GestureViewHolder<T>> : RecyclerView.Adapter<K>(),
    Transactional<T> {
    ...
    internal interface OnGestureListener<T> {
        ...
        fun onEndDrag(viewHolder: GestureViewHolder<T>)
    }
            ...
            if (manualDragAllowed && holder.canDrag()) {
                ...
                holder.draggableView?.setOnTouchListener { _, motionEvent ->
                    ...
                    if (motionEvent.action == MotionEvent.ACTION_UP) {
                        gestureListener?.onEndDrag(holder)
                    }
                    false
                }
            } else {
