...
plugins {
    ...
    id ("dagger.hilt.android.plugin") // Apply the dagger hilt android plugin
}
...
android {
    ...
    compileOptions {
        // Set the source and target compatibility for Java
    ...
    kotlinOptions {
        // Set the jvmTarget for the kotlin compiler
        jvmTarget = "17"
    }
